...
def analyze_alarms(alarms = None, alarms_file='alarms_sdwan.json', use_clustering=True, eps=0.1, min_samples=2):
    """
    ...
    output_file = 'sdwan_alarm_reduction_results.json'
...
if __name__ == "__main__":
    results = analyze_alarms(alarms_file='alarms_sdwan.json')
