...
import modules.ping_client1 as ping_client1
import modules.ping_client2 as ping_client2 
...
def ping_all():
    ...
    ping_functions = [
        ping_client1.ping_from_remote_linux,
        ping_client2.ping_from_remote_linux,
