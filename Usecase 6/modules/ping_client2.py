...
linux_device = {
    'host': '198.18.1.112',  # Replace with your remote linux machine's IP address
...
target_ips = ['10.1.0.2','10.0.2.10','10.0.4.10']
...
def ping_from_remote_linux(device=linux_device, target_ips=target_ips):
    ...
    try:
        ...
        alarm = {"alarm": "ping from client2", "results": outputs}
